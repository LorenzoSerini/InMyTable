...
public class NotificationTest {
    ...
    void testJoinToMealNotification() throws Exception {
        ...
        //create a meal
        Meal meal = new Meal(user1,3,LocalDate.parse("2021-05-29"), LocalTime.now(),LocalDate.parse("2021-05-29"),LocalTime.now(),"",false,"", ConsumationType.AT_HOME,"","", PaymentType.EXCHANGE,"0");
    ...
    void testAcceptPublicRequestNotification() throws Exception {
        ...
        MealRequest request = MealManager.getInstance().createPublicMealRequest(user, "mealType", ConsumationType.AT_HOME,
    ...
    void testSendPrivateRequestNotification() throws Exception {
        ...
        MealRequest request1 = MealManager.getInstance().createPrivateMealRequest(user, "", ConsumationType.AT_HOME, PaymentType.CASH, "",LocalDate.parse("2021-05-29"),
                LocalTime.now(), LocalDate.parse("2021-05-29"),
