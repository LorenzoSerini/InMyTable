...
class FoodTest {
    ...
    void mealTest() throws Exception {
        ...
        Meal meal = new Meal(user1,3,LocalDate.parse("2021-07-29"), LocalTime.parse("18:00:00"),LocalDate.parse("2021-07-29"),LocalTime.parse("18:00:00"),"",false,"", "", ConsummationType.AT_HOME,"","", PaymentType.EXCHANGE,"0");
        assertTrue(meal.getState() == MealStates.PENDING);

        //check that the status of the meal is expired when the date has passed
        Meal meal1 = new Meal(user1,3,LocalDate.parse("2021-04-29"), LocalTime.parse("18:00:00"),LocalDate.parse("2021-04-29"),LocalTime.parse("18:00:00"),"",false,"", "", ConsummationType.AT_HOME,"","", PaymentType.EXCHANGE,"0");
        ...
        assertThrows(ExpirationTimeException.class, ()-> new Meal(user1,3,LocalDate.parse("2021-04-29"), LocalTime.parse("18:00:00"),
                ...
                "", "", ConsummationType.AT_HOME,"","", PaymentType.EXCHANGE,"0"));
    ...
    void mealRequestTest() throws Exception {
        ...
        //check the state is pending
        MealRequest request = MealManager.getInstance().createPublicMealRequest(user1, "mealType", ConsummationType.AT_HOME,
        ...
        MealRequest request1 = MealManager.getInstance().createPublicMealRequest(user1, "mealType", ConsummationType.AT_HOME,
       ...
       /* assertThrows(ExpirationTimeException.class , ()-> new MealRequest(user1, "mealType", ConsummationType.AT_HOME,
                PaymentType.CASH, "", LocalDate.parse("2021-04-29"),
...
//               LocalTime.parse("15:00:00"), "0", "", "", 4);
        ...
        MealRequestsController requestsController = new MealRequestsController(user1, null, null);
        assertThrows(TimeTravelException.class, ()->requestsController.postPrivateMealRequest(user1, "mealType","", ConsummationType.AT_HOME,
                PaymentType.CASH, LocalDate.parse("2021-03-29").toString(),
                LocalTime.parse("13:10:00").toString(), LocalDate.parse("2021-03-29").toString(),
                LocalTime.parse("15:00:00").toString(), "0", "", "", 4));


        assertThrows(NullPointerException.class , ()-> new MealRequest(null, "mealType", ConsummationType.AT_HOME,
                PaymentType.CASH, "", LocalDate.parse("2021-04-29"),
                LocalTime.now(), LocalDate.parse("2021-05-29"),
                LocalTime.now(), "0", "", "", 4));
